  ...
  return (
    <div style={{ position: "fixed", inset: 0, overflow: "hidden", background: "#0F1113" }}>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-5 sm:px-10 sm:py-6">
        ...
        <Image src="/logo.png" alt="PRORAB" width={50} height={50} priority style={{ filter: "invert(1) brightness(2)" }} />
      ...
      >
        ...
        <section style={{ position: "relative", width: "100%", height: "100vh", overflow: "hidden" }}>
          ...
          <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to top, #0F1113 0%, transparent 40%)" }} />
          <div style={{ position: "absolute", bottom: "60px", left: 0, right: 0, display: "flex", justifyContent: "center", padding: "0 24px" }}>
            <p style={{ fontSize: "22px", fontWeight: 300, letterSpacing: "0.15em", color: "#fff", textAlign: "center", textShadow: "0 1px 12px rgba(0,0,0,0.5)", fontFamily: "Montserrat, sans-serif" }}>
              {t.hero.slogan}
            </p>
          </div>
          {/* Scroll hint */}
          <div style={{ position: "absolute", bottom: "20px", left: "50%", transform: "translateX(-50%)", display: "flex", flexDirection: "column", alignItems: "center", gap: "6px", opacity: 0.5 }}>
            <div style={{ width: "1px", height: "40px", background: "#CFC7BD", animation: "scrollHint 1.5s ease-in-out infinite" }} />
          </div>
        </section>
